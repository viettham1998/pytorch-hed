...
# end
os.makedirs(arguments_strOut, exist_ok=True)
##########################################################
...
def estimate(tenInput):
    ...
    tmpWidth = intWidth
    print(intHeight)
    assert(intWidth == tmpWidth) # remember that there is no guarantee for correctness, comment this line out if you acknowledge this and want to continue
    assert(intHeight == tmpHeight) # remember that there is no guarantee for correctness, comment this line out if you acknowledge this and want to continue
